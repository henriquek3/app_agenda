<?php require_once '../_models/select.php'; require_once '../_models/pdo.php'; $id = $_SESSION['id_usuario'];
                    ...
                    <?php
                        while ($gridGrupo = $result->fetch()){
                            ...
                            echo '<td align="right"><button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#modalGrupos" data-idgrupo="'.$gridGrupo['id_grupo'].'" data-whatever="'.$gridGrupo['nome'].'">Alterar</button>'.
                                ' '.
                                '<a href="../_controllers/cadastra_grupos.php?action=excluir&id='.$gridGrupo['id_grupo'].'"><button type="button" class="btn btn-outline-danger btn-sm">Excluir</button><a/>'.'</td>';
                            echo '</tr>';
                        }
                    ?>
                </tbody>
